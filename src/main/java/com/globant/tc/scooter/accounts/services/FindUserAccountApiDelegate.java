...
import com.globant.tc.scooter.accounts.controllers.FindUserAccountApiController;
...
public interface FindUserAccountApiDelegate {
     ...
     */
    default ResponseEntity<Long> findUserAccountUserIdGet(Long userId) {
